...
<div class="w3-content w3-section" style="max-width:500px">
  ...
  <img class="mySlides w3-animate-right" src="d.JPEG" style="width:200%;height:90%">
  <img class="mySlides w3-animate-right" src="e.jpg" style="width:200%;height:90%">
  <img class="mySlides w3-animate-right" src="f.jpg" style="width:200%;height:90%">
</div>
<div>
<img src="footer.png">
</div>
