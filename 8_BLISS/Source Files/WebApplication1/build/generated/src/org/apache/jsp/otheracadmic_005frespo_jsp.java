...
public final class otheracadmic_005frespo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            }\n");
      out.write("            input{\n");
      out.write("                height:60px;font-size:12pt;\n");
      out.write("            }\n");
      out.write("            .d{\n");
      out.write("                font-size:15pt;font-style:normal;font-weight:bolder ;height:30px\n");
      out.write("            }\n");
      out.write("            body{\n");
      ...
      out.write("        </style>\n");
      out.write("    <body>\n");
      out.write("        <form name=\"otheracadmic_respo.jsp\" method=\"get\" action=\"institutional_respo.jsp\">\n");
      out.write("        \n");
...
ResultSet rs=null,rs1=null;
       rs= q.get_data("select * from other_academic_respo where uid='"+session.getAttribute("userid")+"'and Year="+session.getAttribute("year1")+"");
   while(rs.next())
   {
      ...
      out.write("<br>\n");
      out.write("           \n");
      out.write("<center>  <input style=\"height:40px;font-size:15pt;\" type=\"submit\" value=\"next>>\"  />\n");
      out.write("           </center>\n");
      out.write("       \n");
      out.write("          \n");
      out.write("          \n");
