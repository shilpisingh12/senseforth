<%-- 
    Document   : about us
    Created on : Jan 12, 2017, 5:20:34 PM
    Author     : Student
--%>
...
<html>
    ...
    <body>
                <table><tr>
                        <td></td>
                        <td > <a href="home_demo.jsp"><font size="5">&lt;&lt;Home</font></a></td></tr>
            <tr>
                <td><img src="aim.jpeg" align="left"></td><td rowspan="2"><H1><font color="skyblue">ABOUT US</font></H1><HR><font color="white" >Banasthali Vidyapith is a fully residential women's university which offers an integrated system extending from the primary to the Ph.D. level. 
...
<br>(i) Physical<br> (ii) Practical<br>(iii) Aesthetic<br> (iv) Moral <br> (v) Intellectual. <br>This way the students develop an integrated and balanced personality.
