...
<html>
    ...
    <body>
        <form name="h_institutional_respo" method="get" >
...
ResultSet rs=null,rs1=null;
       rs= q.get_data("select * from other_insti_respo where uid='"+session.getAttribute("uid")+"'and Year='"+session.getAttribute("yr")+"'");
   while(rs.next())
   {
